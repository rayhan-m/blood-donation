            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class=" vbh">
                            @if (Auth::user())
                                <a href="{{route('donate_blood')}}"><div class="btn btn-success  bounceInUp"> Donate Blood </div></a>
                            @else
                                <a href="{{route('register')}}"><div class="btn btn-success  bounceInUp"> Become a Donar </div></a>
                            @endif
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="{{asset('frontend/assets/images/slider/slide-03.jpg')}}" alt="Third slide">
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        ...
                        <div class=" vbh">
                            @if (Auth::user())
                                <a href="{{route('register')}}"><div class="btn btn-success  bounceInUp"> Donate Blood </div></a>
                            @else
                                <a href="{{route('register')}}"><div class="btn btn-success  bounceInUp"> Become a Donar </div></a>
                            @endif
            ...
            <div class="container">
                ...
                <div class="row news-row">
                    ...
                    <div class="col-md-6">
                        <div class="news-card">
                            <div class="image">
                                <img src="{{asset('frontend/assets/images/blog/blog_03.jpg')}}" alt="">
                            </div>
                            <div class="detail">
                    ...
                    <div class="col-md-6">
                        <div class="news-card">
                            <div class="image">
                                <img src="{{asset('frontend/assets/images/blog/blog_04.jpg')}}" alt="">
                            </div>
                            <div class="detail">
                                <h3>Latest News about Smarteye</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce fringilla vel nisl a dictum. Donec ut est arcu. Donec hendrerit consectetur adipiscing elit. </p>
